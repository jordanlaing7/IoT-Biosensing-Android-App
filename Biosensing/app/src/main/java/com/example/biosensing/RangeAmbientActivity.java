...
public class RangeAmbientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_range_ambient);
        ...
        GraphView graph = (GraphView) findViewById(R.id.rangeAmbientGraph);
        ...
        String query = "select time, temp from dbo.tempA where (time >= ?) and (time <= ?) order by time asc";
        try{
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                ...
                Toast.makeText(RangeAmbientActivity.this, "Date/Time, Temperature:\n"+dp, Toast.LENGTH_LONG).show();
            }
        });
